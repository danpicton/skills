...
- **[secret-guardrails-claude-code](./secret-guardrails-claude-code/SKILL.md)** — Set up Claude Code hooks to block Claude from reading secrets files and running secret-decryption commands.
